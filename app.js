...
(() => {
  const state = { products: [], announcements: [], query: "", category: "Tümü" };
  ...
  async function loadInitialProducts() {
    try {
      ...
      console.warn("products.json okunamadı, yedek veri kullanılıyor.", error);
    }

    state.products = getFallbackProducts().map(normalizeProduct);
  }
